...
const mergingProcessTest = async () => {
    ...
    anonymousCart = await checkout.addLineItemsToCart(anonymousCart.body.id, "valid-channel-id", ['tulip-seed-box', 'tulip-seed-box', 'tulip-seed-box']);

    customerCart = await checkout.addLineItemsToCart(customerCart.body.id, "valid-channel-id", ['tulip-seed-box', 'tulip-seed-sack', 'tulip-seed-package']);
